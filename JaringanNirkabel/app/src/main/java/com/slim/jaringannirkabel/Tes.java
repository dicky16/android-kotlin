package com.slim.jaringannirkabel;
...
public class Tes extends AppCompatActivity {
    ...
    private final BluetoothGattCallback gattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            Toast.makeText(Tes.this,""+characteristic.toString(),Toast.LENGTH_LONG).show();
            gatt.disconnect();
        }
    };
    ...
    private void checkLocationPermission() {
        if(isReadStorageAllowed()){
            ...
            Toast.makeText(Tes.this,"You already have the permission",Toast.LENGTH_LONG).show();
    ...
    public void connectToBle(View view) {
